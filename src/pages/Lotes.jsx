...
export default function Lotes() {
  ...
  const filtered = properties.filter(p => p.type === 'lot');
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Invertí en tu futuro. Desarrollá tu proyecto desde cero en las mejores zonas de la ciudad y alrededores.
        </p>
      </div>
      ...
      {!loading && filtered.length === 0 && (
         <div className="text-center py-12 bg-white rounded-xl shadow-sm border border-border">
            <p className="text-xl text-muted-foreground">Por el momento no hay lotes publicados.</p>
         </div>
      )}
    </div>
  );
